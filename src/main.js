<div
  className="signature"
  id="signature"
  style={{ position: "relative", width: 640, height: 284 }}
>
  <div className="backgound" style={{ position: "relative" }}>
    <img
      width="640px"
      height="284px"
    ...
    <div
      className="content"
      style={{ height: "74%", position: "absolute", top: "0%", left: "15%" }}
    >
      <div
        className="upperContent"
        style={{ display: "flex", justifyContent: "center" }}
      >
        <div className="left-content" style={{ marginTop: 5 }}>
          <h1
            style={{
              padding: 0,
              margin: 0,
          ...
          >
            <h5
              style={{ margin: 0, fontSize: 13, color: "white" }}
              className="white"
            >
              +61 400 462 248
            </h5>
            ...
            >
              <a
                className="white"
                style={{ color: "white" }}
                href="http://www.makeithappenhq.com.au"
              >
            ...
            <div className="icons" style={{ display: "flex", marginTop: 10 }}>
          ...
          >
            <h5
              className="white"
              style={{ margin: 0, marginTop: 7, fontSize: 10, color: "white" }}
            >
    ...
    <div className="footer" style={{ position: "absolute", top: "72%" }}>
      ...
      >
        ...
        <h5 style={{ fontSize: 8, margin: 0, marginLeft: 20 }}>
          ...
          respects to my people, the Yawuru and Bunuba elders, past, present and
          emerging
        </h5>
      </div>
    </div>
